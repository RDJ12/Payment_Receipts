...
<center><?=(($this->session->flashdata('mess'))?$this->session->flashdata('mess'):'');?></center>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Warm Leads</li>
      </ol>
    </nav>
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
          <div class="card card_border p-4">
            <h3 class="card__title position-absolute">Warm Leads Info</h3>
                             ...
                             <td class="act">
                                ...
                                <?php 
                                    ...
                                    <?php }
                                     ...
                                     { ?>
                                         <a class="assg cmn" href="<?=base_url('Admin_Control/assign/'.$rv->id);?>">Assign</a> 
                                    <?php }
