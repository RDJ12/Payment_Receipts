...
<center><?=(($this->session->flashdata('mess'))?$this->session->flashdata('mess'):'');?></center>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Domestic Leads</li>
      </ol>
    </nav>
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
          <div class="card card_border p-4">
            <h3 class="card__title position-absolute">Domestic Leads Info</h3>
                  ...
                  <?php 
                      ...
                      ?>
                         <tr <?php if($rv->checked==0){ ?> style="background:#f5b4b4;"  <?php  }else{ ?>style="background:#a8e2a8;" <?php } ?>>
                             ...
                             <td class="act">
                                 <a class="rem cmn" href="<?=base_url('Admin_Control/add_remark/'.$rv->id);?>">Remark</a>
                                ...
                                <?php 
                                    ...
                                    <?php }
                                     ...
                                     { ?>
                                         <a class="assg cmn" href="<?=base_url('Admin_Control/domestic_assign/'.$rv->id);?>">Assign</a> 
                                    <?php }
                                 
                                 ?>
                                 
                                 <?php if($_SESSION['user_type']==3){ ?>
                                  <a class="cmn ret" href="<?=base_url('Admin_Control/view_retro_quotation/'.$rv->id);?>">Retro Quotation</a>
                                 <?php if($rv->checked==0){ ?>
                                 ...
                                 <?php if($_SESSION['user_type']==2 || $_SESSION['user_type']==3){ ?>
                                   <a class="cmn ret" href="<?=base_url('Admin_Control/add_lead/'.$rv->id);?>">Edit</a>
                                 <?php } ?>
