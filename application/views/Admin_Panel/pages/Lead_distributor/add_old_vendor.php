...
<center><?=(($this->session->flashdata('mess'))?$this->session->flashdata('mess'):'');?></center>
    ...
    <form method="POST" action="<?=base_url('Admin_Control/add_old_vendor/');?>" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input  autocomplete="off" name="mobile" type="text" class="form-control input-style" id="mobile_check_vendor"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input  autocomplete="off" name="email" type="email" class="form-control input-style" id="email_check_vendor"
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                            <label class="input__label">GST No.</label>
                            <input  autocomplete="off" name="gst_no" type="text" class="form-control input-style" id="gst_check_vendor"
                                aria-describedby="emailHelp" required value="<?=(($edit_data)?$edit_data->email:'');?>">
                                <span style="color:red;" id="err_gst"></span>
                        </div>
                        </div>
                  ...
                  <?php 
                      ...
                      foreach($allold as $rv){ ?>
                         <tr>
                             ...
                             <td><a class="btn btn-xs btn-success text-white" onclick="show_vendor_mapping(<?=$rv->id;?>)">View</a></td>
                         </tr>
                       <?php } ?>
