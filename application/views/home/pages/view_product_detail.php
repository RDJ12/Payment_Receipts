            ...
            <div class="mini-cart-product-area ltn__scrollbar">
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="<?=base_url('/assets/web');?>/img/product/1.png" alt="Image"></a>
                ...
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="<?=base_url('/assets/web');?>/img/product/2.png" alt="Image"></a>
                        <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
                ...
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="<?=base_url('/assets/web');?>/img/product/3.png" alt="Image"></a>
                        <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
                ...
                <div class="mini-cart-item clearfix">
                    <div class="mini-cart-img">
                        <a href="#"><img src="<?=base_url('/assets/web');?>/img/product/4.png" alt="Image"></a>
                        <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                    </div>
                    <div class="mini-cart-info">
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                    <a href="index.html"><img src="<?=base_url('/assets/web');?>/img/logo.png" alt="Logo"></a>
                </div>
                <button class="ltn__utilize-close">×</button>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-4">
                        <a href="img/img-slide/31.jpg" data-rel="lightcase:myCollection">
                            <img src="<?=base_url('/assets/web');?>/img/img-slide/31.jpg" alt="Image">
                        </a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-4">
                        <a href="img/img-slide/32.jpg" data-rel="lightcase:myCollection">
                            <img src="<?=base_url('/assets/web');?>/img/img-slide/32.jpg" alt="Image">
                        </a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-4">
                        <a href="img/img-slide/33.jpg" data-rel="lightcase:myCollection">
                            <img src="<?=base_url('/assets/web');?>/img/img-slide/33.jpg" alt="Image">
                        </a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-4">
                        <a href="img/img-slide/34.jpg" data-rel="lightcase:myCollection">
                            <img src="<?=base_url('/assets/web');?>/img/img-slide/34.jpg" alt="Image">
                        </a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-4">
                        <a href="img/img-slide/35.jpg" data-rel="lightcase:myCollection">
                            <img src="<?=base_url('/assets/web');?>/img/img-slide/35.jpg" alt="Image">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                        ...
                        <label><span class="ltn__secondary-color"><i class="flaticon-pin"></i></span> <?=$product_detail->location;?></label>
                        ...
                        <div class="property-detail-info-list section-bg-1 clearfix mb-60">                          
                            <ul>
                                <li><label>Bedroom:</label> <span><?=$product_detail->bedroom;?></span></li>
                                <li><label>Hall:</label> <span><?=$product_detail->hall;?></span></li>
                            </ul>
                            <ul>
                                <li><label>Kitchen:</label> <span><?=$product_detail->kitchen;?> </span></li>
                            </ul>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="apartments-plan-img">
                                                    <img src="<?=base_url('/assets/web');?>/img/others/10.png" alt="#">
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
                                ...
                                <div class="ltn__comment-inner">
                                    <ul>
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="<?=base_url('/assets/web');?>/img/testimonial/1.jpg" alt="Image">
                                                </div>
                                        ...
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="<?=base_url('/assets/web');?>/img/testimonial/3.jpg" alt="Image">
                                                </div>
                                                <div class="ltn__commenter-comment">
                                                    <h6><a href="#">Adam Smit</a></h6>
                                                    <div class="product-ratting">
                                        ...
                                        <li>
                                            <div class="ltn__comment-item clearfix">
                                                <div class="ltn__commenter-img">
                                                    <img src="<?=base_url('/assets/web');?>/img/testimonial/2.jpg" alt="Image">
                                                </div>
                                                <div class="ltn__commenter-comment">
                                                    <h6><a href="#">Adam Smit</a></h6>
                                                    <div class="product-ratting">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-6 col-12">
                                <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                    <div class="product-img">
                                        <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product-3/1.jpg" alt="#"></a>
                                        <div class="real-estate-agent">
                                            <div class="agent-img">
                                                <a href="team-details.html"><img src="<?=base_url('/assets/web');?>/img/blog/author.jpg" alt="#"></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-sm-6 col-12">
                                <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                    <div class="product-img">
                                        <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product-3/2.jpg" alt="#"></a>
                                        <div class="real-estate-agent">
                                            <div class="agent-img">
                                                <a href="team-details.html"><img src="<?=base_url('/assets/web');?>/img/blog/author.jpg" alt="#"></a>
                                            </div>
                    ...
                    <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                        ...
                        <div class="widget ltn__author-widget">
                            <div class="ltn__author-widget-inner text-center">
                                <img src="<?=base_url('/assets/web');?>/img/team/4.jpg" alt="Image">
                        ...
                        <div class="widget ltn__top-rated-product-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product/1.png" alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product/2.png" alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                                                <ul>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product/3.png" alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                                                <ul>
                        ...
                        <div class="widget ltn__popular-product-widget">       
                            ...
                            <div class="row ltn__popular-product-widget-active slick-arrow-1">
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product-3/6.jpg" alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="<?=base_url('/assets/web');?>/img/blog/author.jpg" alt="#"></a>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product-3/4.jpg" alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="<?=base_url('/assets/web');?>/img/blog/author.jpg" alt="#"></a>
                                                </div>
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product-3/5.jpg" alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="<?=base_url('/assets/web');?>/img/blog/author.jpg" alt="#"></a>
                                                </div>
                        ...
                        <div class="widget ltn__popular-post-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="<?=base_url('/assets/web');?>/img/team/5.jpg" alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="<?=base_url('/assets/web');?>/img/team/6.jpg" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="<?=base_url('/assets/web');?>/img/team/7.jpg" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="<?=base_url('/assets/web');?>/img/team/8.jpg" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                cing elit, sed do.</a></h6>
                        ...
                        <div class="widget ltn__banner-widget d-none">
                            <a href="shop.html"><img src="<?=base_url('/assets/web');?>/img/banner/2.jpg" alt="#"></a>
                        </div>
                    </aside>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row ltn__related-product-slider-two-active slick-arrow-1">
                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="product-details.html"><img src="<?=base_url('/assets/web');?>/img/product-3/3.jpg" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="team-details.html"><img src="<?=base_url('/assets/web');?>/img/blog/author.jpg" alt="#"></a>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="<?=base_url('/assets/web');?>/img/product/4.png" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="<?=base_url('/assets/web');?>/img/product/1.png" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                         ...
                                         <div class="additional-info d-none">
                                            ...
                                            <div class="payment-method">
                                                <img src="<?=base_url('/assets/web');?>/img/icons/payment.png" alt="#">
                                            </div>
                                         </div>
                                    </div>
                                </div>
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="<?=base_url('/assets/web');?>/img/product/7.png" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                            <h5><a href="product-details.html">Brake Conversion Kit</a></h5>
