...
<section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-contact py-5">
        <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
            <h2 class="title">I am an Institutional  Customer / Hospital</h2>
            <ul class="breadcrumbs-custom-path mt-2 text-center">
                <li><a href="<?=base_url();?>">Home</a></li>
                <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> I am an Institutional  Customer / Hospital </li>
            </ul>
        </div>
    </div>
</section>
...
?>
        ...
        <div class="form-inner-cont mt-4">
                <form id="msform" action="<?=base_url('home/form_2/');?>" method="post" class="signin-form cus-form">
                    <h2 class="fs-title">Tell Us About Your Organization</h2>
                    <p class="sub"><i class="fa fa-lock"></i> Your information is safe with us.</p>
                    <div class="form-group">
                        <i class="fa fa-address-card"></i>
                        <input type="text" name="organisation_name" id="w3lName" placeholder="Organization name " required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="website" id="w3lName" placeholder="Website"  required>
                    </div>
                    <div class="form-group">
                        <i class="fa fa-database"></i>
                        <input type="number" name="no_oc" id="w3lName" placeholder="No. of Oxygen concentrator machines you want AMC for"  required>
                    </div>
                    <div class="form-group">
                        <i class="fa fa-ticket"></i>
                        <input type="text" name="brand" id="w3lName" placeholder="Brand & Country of OC"  required>
                    </div>
                    <div class="form-group">
                        <i class="fa fa-user"></i>
                        <input type="text" name="contact_name" id="w3lName" placeholder="Contact person name"  required>
                    </div>
                    <div class="form-group">
                        <i class="fa fa-phone"></i>
                        <input type="number" name="phone" id="w3lName" placeholder="Phone"  required>
                    </div>
                    <div class="form-group txt-ar">
                        <i class="fa fa-address-book"></i>
                        <textarea name="address" id="message" placeholder="Address" required=""></textarea>
                    </div>
                    <div class="form-group txt-ar">
                        <i class="fa fa-comments"></i>
                        <textarea name="comment" id="comment" placeholder="Any Other Comments" required=""></textarea>
                    </div>
