                ...
                <div class="contact-infos">
                    <div class="single-contact-infos">
                        ...
                        <div class="text-box">
                            ...
                            <p><a href="tel:+918700702823">8700702823</a></p>
                            <p>What's App: 8700702823</p>
                        </div>
                    </div>
                    <div class="single-contact-infos">
                        ...
                        <div class="text-box">
                            ...
                            <p> <a href="mailto:care@oxicare.in">care@oxicare.in</a></p>
                        </div>
                    </div>
                    
                </div>
                <div class="single-contact-infos mt-3">
                        <div class="icon-box"> <span class="fa fa-envelope"></span></div>
                        <div class="text-box">
                            <h3 class="mb-1">Address</h3>
                            <p>Oxi Care
C/o. Prime Digitronics Services Pvt Ltd
31, Prathibha Industrial Area,Yelachenahalli,
Bangalore 560111,
Karnataka, India
</p>
                        </div>
        ...
        <div class="row mt-5">
            <div class="col-lg-6 map">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15557.364675445418!2d77.65793!3d12.8857702!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x539f0143ba705863!2sPrime%20Digitronics%20Services%20Private%20Limited!5e0!3m2!1sen!2sin!4v1620901912350!5m2!1sen!2sin"
                    frameborder="0" allowfullscreen=""></iframe>
            </div>
            <div class="col-lg-6 form-inner-cont mt-lg-0 mt-sm-5 mt-4">
                <form id="form2" method="post" class="signin-form">
                    ...
                    <div class="text-right">
                        <button  id="submit_form" type="submit" class="btn btn-style btn-primary">Submit</button>
                    </div>
                </form>
            </div>
        </div>
