...
<section class="w3l-about-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
            <h2 class="title">Oxi Care's GDPR Commitment</h2>
            <ul class="breadcrumbs-custom-path mt-2 text-center">
                <li><a href="<?=base_url();?>">Home</a></li>
                <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Oxi Care's GDPR Commitment </li>
            </ul>
        </div>
    </div>
</section>

<section class="w3l-homeblock2 py-lg-5 " id="work">
    <div class="midd-w3 py-5">
        <div class="container">
            <div class="row">
                
                <div class="col-lg-12 mt-lg-0 mt-sm-5 mt-4 align-self">
                   
                    
                    <h5 class="mt-3">Our commitment and the protection of your data </h5>
                    <p class="mt-4">We’re committed to helping Oxi Care customers and users understand and, where applicable, comply with the General Data Protection Regulation (GDPR). The GDPR is the most comprehensive EU data privacy law in decades and came into effect on 25 May 2018.
</p>
                    <p class="mt-4">In addition to strengthening and standardising user data privacy across EU member states, it introduces new or additional obligations on all organisations that handle EU citizens’ personal data, regardless of where the organisations are located. On this page, we explain how we help our customers comply with the GDPR.
</p>
<h5 class="mt-3">GDPR compliance</h5>
<p class="mt-4">The GDPR’s updated requirements are significant, and team help our customer comply with the regulation. Measures include:
</p>
...
<li>Support for international data transfers by executing standard contractual clauses through our updated 
</li>
</ul>
<p class="mt-4">We also monitor the guidance around GDPR compliance from privacy-related regulatory bodies and update our product features and contractual commitments accordingly. We’ll provide you with regular updates so that you’re always up to date.</p>
<h5 class="mt-3">Updates</h5>
<p class="mt-4">At Oxi Care, we are committed to the security and privacy of your data. So we’re glad to comply, and help you to comply, with the GDPR. If you have any questions about your rights under the GDPR as a user, or how Oxi Care can help you with compliance as a customer, we hope that you’ll get in touch with us at <a href="mailto:privacy@oxicare.in">privacy@oxicare.in</a> </p>
                    <!--<a href="about.html" class="btn btn-style btn-primary mt-sm-5 mt-4">More</a>-->
                </div>
            </div>
...
<script src="https://www.oxicare.in/assets/js/jquery.magnific-popup.min.js"></script>
<script>
  $(document).ready(function () {
...
<script src="https://www.oxicare.in/assets/js/bootstrap.min.js"></script>
