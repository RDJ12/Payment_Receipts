            ...
            <div class="card cus-form">
                ...
                <div class="row">
                    ...
                    <div class="form-inner-cont mt-4">
                        <form id="msform"  action="<?=base_url('home/form_1/');?>" method="post">
                            <!-- progressbar -->
                            <ul id="progressbar">
                                <li class="active" id="account"><strong>Basic Detail</strong></li>
                                <li id="personal"><strong>O2 Concentrator Capacity</strong></li>
                                <li id="payment"><strong>Country of Origin</strong></li>
                                <li id="package"><strong>Plan Detail</strong></li>
                            </ul> <!-- fieldsets -->
                            <fieldset>
                                <div class="form-card">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <div class="row">
                                    <div class="col-md-8"><h2 class="fs-title">What is the size of your O2 concentrator?</h2> 
                                    <p class="normal">It will help us determine the right plan for you.</p>
                                    <input type="hidden" name="size" id="new_size">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                <div class="col-md-8">
                                    <h2 class="fs-title">Please select the country of origin of you O2 concentrator.</h2> 
                                    <p class="normal">You can find the country of manufacture from the concentrator machine. Please select 'Non-China' if
you do not know the country.</p>
<input type="hidden" name="country" id="new_country">
...
<select class="select" id="country"  required> 
                             ...
                             <fieldset>
                                ...
                                <h2 class="fs-title">Select Plan</h2> 
                                    <p class="normal">Make your selection from one of the annual plans.
<br/>This is the amount you pay before we cover the rest.</p>
                                <div class="row">
                                <div class="col-md-6">
                                <!--<table class="table">
                                <thead>
                                ...
                                <td><del>7980</del> 3990</td>
                                <td><del>11980</del> 5990</td>
                                </tr>
                                <tr>
                                <td><strong>6-9L</strong></td>
                                <td><del>9980</del> 4990</td>
                                <td><del>13980</del> 6990</td>
                                </tr>
                                <tr>
                                <td><strong>>=10L</strong></td>
                                <td><del>13980</del> 6990</td>
                                <td><del>17980</del> 8990</td>
                                ...
                                <td><strong>6-9L</strong></td>
                                <td><del>13980 </del> 6990 </td>
                                <td><del>19980 </del> 9990</td>
                                </tr>
                                <tr>
                                <td><strong>>=10L</strong></td>
                                <td><del>19980 </del> 9990  </td>
                                <td><del>25980  </del> 12990</td>
                        ...
                        <div class="panel-body pprice">
                            <!-- <p><strong>Rs.375/mo.</strong></p>-->
                        </div>
                        <ul class="list-group flist">
                            <li><img src="../assets/images/checked.svg" width="20"> 9 am to 6 pm (Mon - Sat) On-Site Support</li>
                            <li><img src="../assets/images/checked.svg" width="20">  Next Business Day response time</li>
                            <li><img src="../assets/images/checked.svg" width="20"> Part replacement in 3 business days 
*subject to part availiblity</li>
<li><img src="../assets/images/checked.svg" width="20"> 2 Scheduled maintenance per year</li>
<li><img src="../assets/images/checked.svg" width="20"> 9 am to 6 pm remote support & diagnostics
(Mon - Sat)</li>
                        </ul>
                        <div class="splan">
                        ...
                        <tbody>
                        <tr>
                        <td><span style="color:#000;" id="silver_lit"></span></td>
                        <td><span style="color:#000;"  id="silver_lit_price"></span></td>
                        <td><span style="color:#000;"  id="silver_lit_country"></span></td>
                        </tr>
                        </tbody>
                        </table>
                        ...
                        <div class="panel-footer">
                            <input type="submit" name="package1" class="tbtn btn btn-style btn-primary" value="Select Plan" />
                        </div>
                    </div>
                                </div>
                                 <div class="col-md-6">
                        ...
                        <ul class="list-group flist">
                            <li><img src="../assets/images/checked.svg" width="20"> 9 am to 9 pm On-Site Support
(All days except national holidays)</li>
                            <li><img src="../assets/images/checked.svg" width="20">  Same Business Day response time</li>
                            <li><img src="../assets/images/checked.svg" width="20"> Part replacement on same business day 
*subject to part availiblity</li>
                            <li><img src="../assets/images/checked.svg" width="20"> 3 Scheduled maintenance per year</li>
                            <li><img src="../assets/images/checked.svg" width="20"> 9 am to 9 pm remote support & diagnostics
(All days except national holidays)</li>
                            <li><img src="../assets/images/checked.svg" width="20"> One set of consumables to be
...
Once in a year</li>
                        ...
                        <tbody>
                        <tr>
                        <td><span style="color:#000;"  id="gold_lit"></span></td>
                        <td><span style="color:#000;"  id="gold_lit_price"></span></td>
                        <td><span style="color:#000;"  id="gold_lit_country"></span></td>
                        </tr>
                        </tbody>
                        </table>
                        ...
                        <div class="panel-footer">
                            <input type="submit"    name="package2"   class="tbtn btn btn-style btn-primary" value="Select Plan" />
                        </div>
                    </div>
                                </div>
                                </div>
...
$("select.select option").unwrap().each(function() {
    ...
    var btn = $('<div class="btn" onclick="set_size('+aa+')">'+$(this).text()+'</div>');
