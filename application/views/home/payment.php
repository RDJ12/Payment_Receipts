			...
			<div class="container">
				<div class="row">
					...
					<?php
							...
							$card_holder_name = $dd['contact_name'];
							$email = $dd['email'];
							$phone = $dd['phone'];
							$name = 'Oxicare';
						...
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									<label>Name</label>
									<input type="text" name="u_name" id="regusername_p" tabindex="1" class="form-control" placeholder="Username" value="<?=$dd['contact_name'];?>" readonly >
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
									<label>O2 Concentrator Capacity</label>
								<input type="tel" readonly name="phone" id="phone_p" tabindex="1" class="form-control" placeholder="Mobile No" value="<?=$dd['size'];?>">
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="form-group">
