    ...
    <div class="breadcrumb-bg breadcrumb-bg-contact py-5">
        <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3">
            ...
            <ul class="breadcrumbs-custom-path mt-2 text-center">
                ...
                <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Get a Quote </li>
            </ul>
        </div>
    </div>
</section>
...
<div class="w3l-contact-info py-5 quote-btns">
    <div class="container py-lg-5 py-md-4">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="title">
                    <h3 class="title-big"><a class="qbtn" href="<?=base_url('home/form_1');?>">I am an Individual <br> Customer</a></h3>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="title">
